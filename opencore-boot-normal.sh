...
args=(
  ...
  -machine pc-q35-4.2,accel=kvm,hpet=off,acpi=on
  ...
  -device ide-hd,bus=ide.2,drive=OpenCoreBoot,bootindex=1
  -device ide-hd,bus=ide.3,drive=InstallMedia
  ...
  -device ide-hd,bus=ide.4,drive=MacHDD
